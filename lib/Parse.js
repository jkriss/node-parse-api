...
Parse.prototype = {
  ...
  insertFile: function(fileName, data, contentType, callback){
    parseRequest.call(this, 'POST', '/1/files/' + encodeURIComponent(fileName), data, callback, contentType);
  },
  ...
  find: function (className, query, callback) {
    if (typeof query === 'string') {
      ...
      parseRequest.call(this, 'GET', '/1/classes/' + className, { where: encodeURIComponent(JSON.stringify(query)) }, function(err, results) {
  ...
  findMany: function (className, query, order, limit, callback) {
    ...
    if (typeof(query) === 'string') {
      ...
      parseRequest.call(this, 'GET', '/1/classes/' + className, {limit: limit, order:order, where: encodeURIComponent(JSON.stringify(query)) }, callback);
    }
  },
...
function reformatDatesFromParse(object){
  ...
  for( var key in object){
    if(typeof object[key]==='object'){
      if(object[key] !== null && object[key]["__type"] && object[key]["__type"]==="Date"){
